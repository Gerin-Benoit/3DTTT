...
parser.add_argument('--data_dir', type=str, required=True, default='~/storage/data/shift_dataset',
                    help='Specify the path to the data files directory')
parser.add_argument('--save_path', type=str, required=True, default='~/storage/msseg',
